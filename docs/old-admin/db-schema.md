...
> Generado por `duck-sync-docs --schema` el 2026-05-28T20:39:48Z.
> Entorno: dev (db.civitatis.local). Base de datos: civitatis (MySQL 8.x).
> Scope: módulo `/admin` únicamente (whitelist en `skills/project-context/old_admin.md`).
> Tablas detectadas por heurística: grep `FROM|JOIN|INTO|UPDATE <tabla>` sobre SQL crudo/PDO en los paths de scope.
> La detección sobre SQL crudo es parcial (queries dinámicas, concatenación de strings, aliases) — puede estar incompleto.
> No editar: el siguiente `duck-sync-docs --schema` lo sobrescribe.

> ⚠️ Nota de extracción: el entorno `slave` (default del plan) falló la gate (b) — `@@global.super_read_only=0`.
> Se usó `dev` (Tilt local) como fallback seguro (gate PASS, level=low). Solo DDL/columnas/índices, sin datos.

## Resumen

- **Tablas detectadas (código, scope /admin):** 319
- **Tablas encontradas en DB:** 286
- **Tablas referenciadas no encontradas en DB dev:** 33 (legacy / solo-prod / posibles falsos positivos del regex)

### ⚠️ Tablas referenciadas en código pero no encontradas en DB (dev)

- `actividades_incidencias` — p.ej. `application/admin/actividades/incidencias.php` (probable tabla legacy, solo-prod, o renombrada).
- `alojamientos` — p.ej. `application/admin/hoteles/scripts/crearTablaHotelesIntermediaOld.php` (probable tabla legacy, solo-prod, o renombrada).
- `bookings` — p.ej. `application/admin/script-pagos-agencias-v3.php` (probable tabla legacy, solo-prod, o renombrada).
- `collections_tags_pages` — p.ej. `application/admin/guias/loadPagesTags.php` (probable tabla legacy, solo-prod, o renombrada).
- `destinos_cerca_destinos` — p.ej. `application/admin/hoteles/editarDestino.php` (probable tabla legacy, solo-prod, o renombrada).
- `distritos` — p.ej. `application/admin/hoteles/scripts/actualizarDistritos.php` (probable tabla legacy, solo-prod, o renombrada).
- `distritos_alojamientos` — p.ej. `application/admin/hoteles/scripts/actualizarDistritos.php` (probable tabla legacy, solo-prod, o renombrada).
- `encanto_destinos` — p.ej. `application/admin/hoteles/actualizarDatos2.php` (probable tabla legacy, solo-prod, o renombrada).
- `encanto_estadisticas` — p.ej. `application/admin/hoteles/estadisticas.php` (probable tabla legacy, solo-prod, o renombrada).
- `encanto_hoteles` — p.ej. `application/admin/hoteles/editarHotel.php` (probable tabla legacy, solo-prod, o renombrada).
- `encanto_hoteles_cerca_hoteles` — p.ej. `application/admin/hoteles/editarHotel.php` (probable tabla legacy, solo-prod, o renombrada).
- `hotel_descriptions` — p.ej. `application/admin/hoteles/scripts/actualizarDescripciones.php` (probable tabla legacy, solo-prod, o renombrada).
- `hoteldescriptions` — p.ej. `application/admin/hoteles/scripts/crearTablaHotelesIntermediaOld.php` (probable tabla legacy, solo-prod, o renombrada).
- `hotels` — p.ej. `application/admin/hoteles/editarHotel.php` (probable tabla legacy, solo-prod, o renombrada).
- `locationtomedias` — p.ej. `application/admin/hoteles/scripts/crearTablaHotelesIntermediaOld.php` (probable tabla legacy, solo-prod, o renombrada).
- `mailchimp` — p.ej. `application/admin/proveedores/modificarProveedor.php` (probable tabla legacy, solo-prod, o renombrada).
- `medias` — p.ej. `application/admin/hoteles/scripts/eliminarFotos.php` (probable tabla legacy, solo-prod, o renombrada).
- `paginas` — p.ej. `application/admin/scriptsDB/cambiarTextoFotos.php` (probable tabla legacy, solo-prod, o renombrada).
- `paises_ciudades` — p.ej. `application/admin/scriptsDB/dumpCiudadesGeoName.php` (probable tabla legacy, solo-prod, o renombrada).
- `payments` — p.ej. `application/admin/script-pagos-agencias-v3.php` (probable tabla legacy, solo-prod, o renombrada).
- `payments_bookings` — p.ej. `application/admin/script-pagos-agencias-v3.php` (probable tabla legacy, solo-prod, o renombrada).
- `puntos_interes` — p.ej. `application/admin/hoteles/destinos.php` (probable tabla legacy, solo-prod, o renombrada).
- `puntos_interes_categorias` — p.ej. `application/admin/hoteles/editarPoi.php` (probable tabla legacy, solo-prod, o renombrada).
- `reservas` — p.ej. `application/admin/hoteles/scripts/actualizarReservasPasadas.php` (probable tabla legacy, solo-prod, o renombrada).
- `sendgrid` — p.ej. `application/lib/Admin/WebhookEmailController.php` (probable tabla legacy, solo-prod, o renombrada).
- `temp_alojamientos_distrito` — p.ej. `application/admin/hoteles/scripts/actualizarDistritos.php` (probable tabla legacy, solo-prod, o renombrada).
- `transfer` — p.ej. `application/admin/it/update_transfers_count.php` (probable tabla legacy, solo-prod, o renombrada).
- `traslados_ciudades` — p.ej. `application/admin/traslados/modificarProveedor.php` (probable tabla legacy, solo-prod, o renombrada).
- `viajes_ofertas` — p.ej. `application/admin/tareas/obtenerOfertas.php` (probable tabla legacy, solo-prod, o renombrada).
- `viajes_origen_datos` — p.ej. `application/admin/tareas/obtenerOfertas.php` (probable tabla legacy, solo-prod, o renombrada).
- `zonas` — p.ej. `application/admin/hoteles/destinosZona.php` (probable tabla legacy, solo-prod, o renombrada).
- `zonas_destinos` — p.ej. `application/admin/hoteles/destinosZona.php` (probable tabla legacy, solo-prod, o renombrada).
- `zonas_horarias` — p.ej. `application/admin/scriptsDB/dumpTimezones.php` (probable tabla legacy, solo-prod, o renombrada).

> Nota: los tokens descartados por ser ruido del regex (aliases, palabras SQL sueltas) no se listan.
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/include/datosPrincipales.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/idiomas.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-ivan-guias-act.php`)
...
### `actividades_cancelaciones`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/index2.php`)
...
```sql
CREATE TABLE `actividades_cancelaciones` (
  `id` int NOT NULL,
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/calendarioActividad.php`)

#### Columnas

| Campo | Tipo | Null | Key | Default | Extra |
|-------|------|------|-----|---------|-------|
| id_actividad | int | NO | PRI | NULL |  |
| fecha | date | NO | PRI | NULL |  |
| hora | int | NO | PRI | NULL |  |
| plazas | int | NO |  | NULL |  |
...
| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | id_actividad, fecha, hora | Sí |

#### DDL

```sql
CREATE TABLE `actividades_disponibilidad` (
  `id_actividad` int NOT NULL,
  `fecha` date NOT NULL,
  `hora` int NOT NULL,
  `plazas` int NOT NULL,
  PRIMARY KEY (`id_actividad`,`fecha`,`hora`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-ruben.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-freetours.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/borrarActividad.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/include/duplicarActividad.php`)
...
CREATE TABLE `actividades_lugares` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9486 DEFAULT CHARSET=utf8mb3 COMMENT='Lugares de las excursiones o actividades en general'
```

### `actividades_opciones`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-datosSolicitados.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-opiniones-ayer.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/markAsPaidBookings.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/verReserva.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/destinos/addDescription.php`)
...
|-------|------|------|-----|---------|-------|
| idActividad | int | NO | PRI | NULL |  |
| idTipo | int | NO | PRI | NULL |  |

#### Índices

| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | idActividad, idTipo | Sí |
...
CREATE TABLE `actividades_tipos` (
  `idActividad` int NOT NULL,
  `idTipo` int NOT NULL,
  PRIMARY KEY (`idActividad`,`idTipo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| idMasterDestino | int | NO |  | NULL |  |
| idMasterTipo | int | NO |  | NULL |  |
...
```sql
CREATE TABLE `actividades_tipos_destinos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idMasterDestino` int NOT NULL,
  `idMasterTipo` int NOT NULL,
  PRIMARY KEY (`id`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/include/loadCategories.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/buscar.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-cancelaciones-update.php`)
...
```sql
CREATE TABLE `activity_changelog` (
  `id` int NOT NULL AUTO_INCREMENT,
  `activity_id` int NOT NULL,
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=713 DEFAULT CHARSET=utf8mb3 COMMENT='Track the changes made in the activity bookings'
```

### `activity_connection_info`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/dump_functions.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/index.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/script_hmartin_nico_fechas-ocupadas.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/translations/activity_variables_translations.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/generate_po_and_clean_cache_all_langs.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/disponibilidadActividades.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-ivan-nuevas-actividades.php`)
...
### `affiliate_billing_comments`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/afiliados/facturacion.php`)
...
```sql
CREATE TABLE `affiliate_billing_comments` (
  `id` int NOT NULL AUTO_INCREMENT,
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/addBookingsToAgency.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/afiliados/subirFicheroAfiliado.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/convert_uk_providers.php`)
...
### `afiliados_autofacturas_historico`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/invoiceAffiliateRegenerate.php`)
...
```sql
CREATE TABLE `afiliados_autofacturas_historico` (
  `id` int NOT NULL AUTO_INCREMENT,
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/afiliados/modificarAfiliado.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-pagos-agencias-v3.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/albums.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/audioguias/index.php`)
...
| puntos | int | NO |  | NULL |  |
| puntos_descripcion | text | NO |  | NULL |  |
| duracion | varchar(24) | NO |  | NULL |  |
| tamano | tinyint | NO |  | NULL |  |
| precio | double | NO |  | NULL |  |
| precio_oferta | double | NO |  | NULL |  |
...
CREATE TABLE `audioguias` (
  ...
  `puntos` int NOT NULL,
  `puntos_descripcion` text NOT NULL,
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| id_audioguia | int | NO |  | NULL |  |
| precio | double | NO |  | NULL |  |
| comision | double | NO |  | NULL |  |
| email | varchar(128) | NO |  | NULL |  |
| ip | varchar(32) | NO |  | NULL |  |
| fecha | timestamp | NO |  | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
| descargas | tinyint | NO |  | NULL |  |
| pin | int | NO |  | NULL |  |
| pagado | tinyint | NO |  | NULL |  |
...
```sql
CREATE TABLE `audioguias_ventas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_audioguia` int NOT NULL,
  `precio` double NOT NULL,
  `comision` double NOT NULL,
  `email` varchar(128) NOT NULL,
  `ip` varchar(32) NOT NULL,
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `descargas` tinyint NOT NULL,
  `pin` int NOT NULL,
  `pagado` tinyint NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7204 DEFAULT CHARSET=utf8mb3
```

### `autofacturas_afiliados`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/generarSEPApagosAfiliados.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/navision/index.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/afiliados/include/estadisticas_functions.php`)
...
### `booking_monetary_history`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/updateMasiveTransferProfit.php`)
...
| booking_type | int | NO |  | NULL |  |
| change_type | varchar(25) | NO |  | NULL |  |
| change_reason | varchar(256) | YES |  | NULL |  |
| date | timestamp | NO |  | CURRENT_TIMESTAMP | DEFAULT_GENERATED on update CURRENT_TIMESTAMP |
| currency_original | varchar(3) | NO |  | NULL |  |
| currency_payment | varchar(3) | NO |  | NULL |  |
| xrt_payment | varchar(21) | YES |  | NULL |  |
| xrt_eur | varchar(21) | YES |  | NULL |  |
| full_price_original | varchar(30) | YES |  | NULL |  |
| profit_original | varchar(30) | YES |  | NULL |  |
| full_price_payment | varchar(30) | YES |  | NULL |  |
| full_price_eur | varchar(30) | YES |  | NULL |  |
| profit_eur | varchar(30) | YES |  | NULL |  |
| full_price_original_diff | varchar(30) | YES |  | NULL |  |
| profit_original_diff | varchar(30) | YES |  | NULL |  |
| full_price_payment_diff | varchar(30) | YES |  | NULL |  |
| full_price_eur_diff | varchar(30) | YES |  | NULL |  |
| profit_eur_diff | varchar(30) | YES |  | NULL |  |
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx-booking_monetary_history-booking_id-booking_type-date | BTREE | booking_id, booking_type, date | No |

#### DDL

```sql
CREATE TABLE `booking_monetary_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `booking_id` int NOT NULL,
  ...
  `currency_payment` varchar(3) NOT NULL,
  `xrt_payment` varchar(21) DEFAULT NULL,
  `xrt_eur` varchar(21) DEFAULT NULL,
  `full_price_original` varchar(30) DEFAULT NULL,
  `profit_original` varchar(30) DEFAULT NULL,
  `full_price_payment` varchar(30) DEFAULT NULL,
  `full_price_eur` varchar(30) DEFAULT NULL,
  `profit_eur` varchar(30) DEFAULT NULL,
  `full_price_original_diff` varchar(30) DEFAULT NULL,
  `profit_original_diff` varchar(30) DEFAULT NULL,
  `full_price_payment_diff` varchar(30) DEFAULT NULL,
  `full_price_eur_diff` varchar(30) DEFAULT NULL,
  `profit_eur_diff` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx-booking_monetary_history-booking_id-booking_type-date` (`booking_id`,`booking_type`,`date`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb3 COMMENT='https://civitatis.atlassian.net/wiki/x/BIDZLQ'
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/hacerFacturasFreetours.php`)
...
| id | int | NO | PRI | NULL | auto_increment |
| booking_id | int | NO |  | NULL |  |
| booking_type | tinyint(1) | NO |  | NULL |  |
| is_free_tour | tinyint(1) | NO |  | NULL |  |
| collaborator_type | varchar(64) | NO |  | NULL |  |
| collaborator_id | varchar(64) | YES |  | NULL |  |
| amount | decimal(12,2) | NO |  | NULL |  |
| currency | varchar(5) | NO |  | NULL |  |
| amount_eur | decimal(12,2) | NO |  | NULL |  |
| created_at | timestamp | NO |  | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
...
CREATE TABLE `booking_penalties` (
  `id` int NOT NULL AUTO_INCREMENT,
  `booking_id` int NOT NULL,
  `booking_type` tinyint(1) NOT NULL COMMENT '1- Actividad 2- Traslado',
  `is_free_tour` tinyint(1) NOT NULL,
  `collaborator_type` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Tipo de entidad a la que se penaliza (enum): ''provider'', ''agency'', ''affiliate'', ''customer''',
  `collaborator_id` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `amount` decimal(12,2) NOT NULL,
  `currency` varchar(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `amount_eur` decimal(12,2) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci COMMENT='Penalizaciones por cancelación de reservas last minute'
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/script_igomez_actividades_reservas_compensatorias_pendientes.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/reservasSinEnviarNavision.php`)
...
### `bookings_status_voxel`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/reenvioAVoxelReservasCambioExpediente.php`)
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_bookings_status_voxel_booking_type_amount_status | BTREE | booking_id, type, status, amount | No |

#### DDL

```sql
CREATE TABLE `bookings_status_voxel` (
  `id` int NOT NULL AUTO_INCREMENT,
  `booking_id` int NOT NULL,
  `type` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_bookings_status_voxel_booking_type_amount_status` (`booking_id`,`type`,`status`,`amount`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-hector-fixqueues.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/guias/categorias.php`)
...
### `categories_translations_changelog`
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| idMasterCategory | int | NO | MUL | NULL |  |
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_categories_translations_changelog | BTREE | idMasterCategory, created_at | No |
| idx_categories_translations_changelog_validated | BTREE | validated | No |

#### DDL

```sql
CREATE TABLE `categories_translations_changelog` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idMasterCategory` int NOT NULL,
  ...
  `validated` int DEFAULT '0' COMMENT '1 - Si 0 - No',
  PRIMARY KEY (`id`),
  KEY `idx_categories_translations_changelog` (`idMasterCategory`,`created_at`),
  KEY `idx_categories_translations_changelog_validated` (`validated`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Track the changes made in the category'
```

### `categories_translations_changelog_validation`
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_categories_translations_changelog_validation | BTREE | idioma | No |

#### DDL

```sql
CREATE TABLE `categories_translations_changelog_validation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idCambio` int NOT NULL,
  `user` varchar(16) NOT NULL,
  `idioma` varchar(2) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_categories_translations_changelog_validation` (`idioma`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/exportar_fact.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/afiliados/crearCobranding.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/guias/modificarPaginaGuia.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturas/listado.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/afiliados/detallesAutofactura.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-pagos-negativos-proveedor.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/translations/comun_variables_translations.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-hector-modalidades.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/include/showChanges.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/translations/contact_categories_translations.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/web/contacto/index.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/web/concursos/index.php`)
...
### `country_landing_faqs`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/scriptFaqPaises.php`)
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| id_master | int | YES |  | NULL |  |
| id_country | int | NO | MUL | NULL |  |
| question | text | YES |  | NULL |  |
| answer | text | YES |  | NULL |  |
| lang | varchar(2) | NO |  | NULL |  |
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_country_landing_faqs_active | BTREE | active | No |
| idx_country_landing_faqs_id_country_lang | BTREE | id_country, lang | No |
| idx_country_landing_faqs_status | BTREE | status | No |

#### DDL

```sql
CREATE TABLE `country_landing_faqs` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_master` int DEFAULT NULL COMMENT 'FAQ master para relaciones multiidioma',
  `id_country` int NOT NULL COMMENT 'Relación con país',
  ...
  `lang` varchar(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL COMMENT 'Estado de la FAQ (0=draft, 1=published, 2=archived)',
  `active` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1=Activa, 0=Inactiva',
  `orden` int DEFAULT NULL COMMENT 'Nivel de importancia para el ordenamiento (1 = más importante)',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_country_landing_faqs_id_country_lang` (`id_country`,`lang`),
  KEY `idx_country_landing_faqs_active` (`active`),
  KEY `idx_country_landing_faqs_status` (`status`),
  CONSTRAINT `fk_id_country` FOREIGN KEY (`id_country`) REFERENCES `paises` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci
```

### `country_popular_activities`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/actualizarPopularidad.php`)
...
| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| country_id | BTREE | country_id, activity_id | Sí |
| idx_country_popular_activities | BTREE | activity_id, country_id | No |

#### DDL

```sql
CREATE TABLE `country_popular_activities` (
  `country_id` int NOT NULL,
  `activity_id` int NOT NULL,
  `popularidad` int NOT NULL,
  `popularidadb2b` int NOT NULL DEFAULT '0' COMMENT 'Popularidad calculada para agencias/Alojamientos',
  UNIQUE KEY `country_id` (`country_id`,`activity_id`),
  KEY `idx_country_popular_activities` (`activity_id`,`country_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Popularidad calculada para agencias/Alojamientos'
```

### `cronjobs`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/tareas/cronjob.php`)
...
| Campo | Tipo | Null | Key | Default | Extra |
|-------|------|------|-----|---------|-------|
| currency_id | int | NO | PRI | 0 |  |
| ratio_code | char(3) | NO | PRI |  |  |
| ratio_value | float | YES |  | NULL |  |

#### Índices

| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | currency_id, ratio_code | Sí |

#### DDL

```sql
CREATE TABLE `currencies_ratio` (
  `currency_id` int NOT NULL DEFAULT '0',
  `ratio_code` char(3) NOT NULL DEFAULT '',
  `ratio_value` float DEFAULT NULL,
  PRIMARY KEY (`currency_id`,`ratio_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
### `destinos_actividades_destacadas`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/destinos/modificarDestino.php`)
...
```sql
CREATE TABLE `destinos_actividades_destacadas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idActividad` int NOT NULL,
  `idTopDestacado` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```

### `destinos_top_destacados`
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| idDestino | int | NO |  | NULL |  |
| title | varchar(256) | NO |  | NULL |  |
| url | varchar(32) | NO |  | NULL |  |
| titleUrl | varchar(100) | NO |  | NULL |  |
...
```sql
CREATE TABLE `destinos_top_destacados` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idDestino` int NOT NULL,
  `title` varchar(256) NOT NULL,
  `url` varchar(32) NOT NULL,
  `titleUrl` varchar(100) NOT NULL,
  `lang` varchar(2) DEFAULT 'es',
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/clean-cache-destinos.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/modificar.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-arreglo-log-chat.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/lib/Dao/Admin/EmailHistoryDao.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/tareas/actualizarEstadisticas.php`)
...
|-------|------|------|-----|---------|-------|
| fecha | date | NO | PRI | NULL |  |
| actividades_reservas | int | NO |  | NULL |  |
| actividades_personas | int | NO |  | NULL |  |
| actividades_ventas | double | NO |  | NULL |  |
| actividades_beneficio | double | NO |  | NULL |  |
| actividades_opiniones | int | NO |  | NULL |  |
| traslados_reservas | int | NO |  | NULL |  |
| traslados_personas | int | NO |  | NULL |  |
| traslados_ventas | double | NO |  | NULL |  |
| traslados_beneficio | double | NO |  | NULL |  |
| traslados_opiniones | int | NO |  | NULL |  |

#### Índices

| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | fecha | Sí |
| fecha | BTREE | fecha | Sí |
...
CREATE TABLE `estadisticas` (
  `fecha` date NOT NULL,
  `actividades_reservas` int NOT NULL,
  `actividades_personas` int NOT NULL,
  `actividades_ventas` double NOT NULL,
  `actividades_beneficio` double NOT NULL,
  `actividades_opiniones` int NOT NULL,
  `traslados_reservas` int NOT NULL,
  `traslados_personas` int NOT NULL,
  `traslados_ventas` double NOT NULL,
  `traslados_beneficio` double NOT NULL,
  `traslados_opiniones` int NOT NULL,
  PRIMARY KEY (`fecha`),
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/viajes/verReserva.php`)
...
### `facturas_clientes_actividades`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/hacerFacturaCliente.php`)

#### Columnas

| Campo | Tipo | Null | Key | Default | Extra |
|-------|------|------|-----|---------|-------|
| id_reserva | int | NO | PRI | NULL |  |
| datos_cliente | text | NO |  | NULL |  |

#### Índices

| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | id_reserva | Sí |

#### DDL

```sql
CREATE TABLE `facturas_clientes_actividades` (
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturas/verFactura.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/generarFacturaFreeToursManual.php`)
...
| empresa | tinyint | NO |  | 1 |  |
| id_proveedor | int | NO | MUL | NULL |  |
| fecha | date | NO |  | NULL |  |
| importe | float | NO |  | NULL |  |
| actividades | float | NO |  | 0 |  |
| traslados | float | NO |  | 0 |  |
| cancelacion_actividades | float | NO |  | 0 |  |
| cancelacion_traslados | float | NO |  | 0 |  |
| otros | float | NO |  | NULL |  |
| pagada | tinyint | YES |  | 0 |  |
| divisa | varchar(3) | YES |  | EUR |  |
| concepto | varchar(256) | YES |  | NULL |  |
| identificacion | varchar(75) | YES |  | NULL |  |
| tipo_identificacion | varchar(3) | YES |  | NULL |  |
| nombre_razon | varchar(100) | YES |  | NULL |  |
| direccion | text | YES |  | NULL |  |
| ciudad | varchar(100) | YES |  | NULL |  |
| cp | varchar(100) | YES |  | NULL |  |
| pais | varchar(2) | YES |  | NULL |  |
| id_factura | int | NO | PRI | NULL | auto_increment |
| region | int | YES |  | NULL |  |
| free_tour_invoice | int | YES |  | 0 |  |
| generic_payment_id | int | YES |  | NULL |  |
| total_paid_with_fees | float | YES |  | NULL |  |
| invoice_year | smallint | YES |  | NULL |  |
| invoice_month | tinyint | YES |  | NULL |  |
| commission_invoice | varchar(50) | YES |  | NULL |  |
| is_sent | tinyint(1) | YES |  | NULL |  |
| bc_error | text | YES |  | NULL |  |

#### Índices

| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | id_factura | Sí |
| idx_fp_id_proveedor_invoice_year_invoice_month | BTREE | id_proveedor, invoice_year, invoice_month | No |
...
CREATE TABLE `facturas_proveedores` (
  ...
  `empresa` tinyint NOT NULL DEFAULT '1',
  `id_proveedor` int NOT NULL,
  `fecha` date NOT NULL,
  `importe` float NOT NULL,
  `actividades` float NOT NULL DEFAULT '0',
  `traslados` float NOT NULL DEFAULT '0',
  `cancelacion_actividades` float NOT NULL DEFAULT '0',
  `cancelacion_traslados` float NOT NULL DEFAULT '0',
  `otros` float NOT NULL,
  `pagada` tinyint DEFAULT '0' COMMENT '0. Sin pagar | 1. Pendiente de pago | 2. Pagada',
  `divisa` varchar(3) DEFAULT 'EUR',
  `concepto` varchar(256) DEFAULT NULL,
  `identificacion` varchar(75) DEFAULT NULL,
  ...
  `free_tour_invoice` int DEFAULT '0',
  `generic_payment_id` int DEFAULT NULL COMMENT 'Id del pago genérico asociado, si lo hubiera.',
  `total_paid_with_fees` float DEFAULT NULL COMMENT 'Importe pagado sumando impuestos',
  `invoice_year` smallint DEFAULT NULL COMMENT 'Billed year',
  `invoice_month` tinyint DEFAULT NULL COMMENT 'Billed month',
  `commission_invoice` varchar(50) DEFAULT NULL COMMENT 'Id Factura de comision en BC',
  `is_sent` tinyint(1) DEFAULT NULL COMMENT 'Estado envio Business Central  (0 - No enviado, 1 - Enviado)',
  `bc_error` text COMMENT 'Error devuelto por Business Central en caso de fallo en el envío',
  PRIMARY KEY (`id_factura`),
  KEY `idx_fp_id_proveedor_invoice_year_invoice_month` (`id_proveedor`,`invoice_year`,`invoice_month`)
) ENGINE=InnoDB AUTO_INCREMENT=6347 DEFAULT CHARSET=utf8mb3 COMMENT='Error devuelto por Business Central en caso de fallo en el envío'
```

### `facturas_proveedores_tours`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/generarSEPApagosProveedor.php`)
...
### `facturas_recibidas_sii`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/generarSEPA.php`)
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| id_factura | varchar(50) | YES |  | NULL |  |
| fecha_factura | date | YES |  | NULL |  |
| tipo_factura | varchar(3) | YES |  | F2 |  |
| tipo_rectificativa | varchar(2) | YES |  |  |  |
| regimen_especial | varchar(2) | NO |  | NULL |  |
| base_rectificativa | double | NO |  | NULL |  |
...
| estado | int | NO |  | 0 |  |
| csv | varchar(50) | YES |  | NULL |  |
| codigo_error | int | YES |  | NULL |  |
| error | text | YES |  | NULL |  |
| fecha_registro_contable | date | YES |  | NULL |  |
| total_iva | double | YES |  | NULL |  |
| num_reintentos | int | YES |  | 0 |  |
| provider_id | int | YES |  | 0 |  |
...
```sql
CREATE TABLE `facturas_recibidas_sii` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_factura` varchar(50) DEFAULT NULL,
  `fecha_factura` date DEFAULT NULL,
  `tipo_factura` varchar(3) DEFAULT 'F2' COMMENT 'F1 - Factura, F2 - Factura simplificada (ticket), F3 - Sustitucion factura simplificada por factura, R4 - Rectificacion factura, R5 - Rectificacion factura simplificada',
  `tipo_rectificativa` varchar(2) DEFAULT '' COMMENT 'S - Por sustitución, I - Por diferencias',
  `regimen_especial` varchar(2) NOT NULL COMMENT '01 - Regimen general, 02 - Exportacion, 05 - Regimen especial agencia de viajes, 08 - Operaciones suejtas al IPSI/IGIC',
  `base_rectificativa` double NOT NULL,
  ...
  `nombre_razon` varchar(100) DEFAULT NULL,
  `fecha_envio` datetime DEFAULT NULL,
  `estado` int NOT NULL DEFAULT '0' COMMENT '0 - Not sended, 2 - Reject, 3 - Accepted with errors, 4 - Accepted',
  `csv` varchar(50) DEFAULT NULL,
  `codigo_error` int DEFAULT NULL,
  `error` text,
  `fecha_registro_contable` date DEFAULT NULL,
...
### `facturas_recibidas_sii_detalles`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/recibidas.php`)
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| id_factura_recibida | int | NO |  | NULL |  |
| pvp | double | NO |  | NULL |  |
| iva | double | NO |  | NULL |  |
...
```sql
CREATE TABLE `facturas_recibidas_sii_detalles` (
  `id` int NOT NULL AUTO_INCREMENT,
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/regularTours.php`)
...
### `facturas_reservas_freetours_proveedor`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturas/factura.php`)
...
```sql
CREATE TABLE `facturas_reservas_freetours_proveedor` (
  `id` int NOT NULL AUTO_INCREMENT,
  `booking_id` int NOT NULL,
  `invoice_id` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=473606 DEFAULT CHARSET=utf8mb3
```

### `facturas_reservas_pago_proveedor`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/facturasBeneficioCivitatisFuturas.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-pagos-agencias-v2.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/verActividad.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/scriptsDB/cambiarTextoFotos.php`)
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| idMasterFoto | int | NO |  | NULL |  |
| idMasterAlbum | int | NO |  | NULL |  |
| field | varchar(32) | NO |  | NULL |  |
| old_value | text | YES |  | NULL |  |
| new_value | text | YES |  | NULL |  |
| created_at | timestamp | NO |  | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
...
```sql
CREATE TABLE `fotos_translations_changelog` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idMasterFoto` int NOT NULL,
  `idMasterAlbum` int NOT NULL,
  `field` varchar(32) NOT NULL,
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Track the changes made in the fotos'
```

### `fotos_translations_changelog_validation`
...
```sql
CREATE TABLE `fotos_translations_changelog_validation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idCambio` int NOT NULL,
  `user` varchar(16) NOT NULL,
  `idioma` varchar(2) NOT NULL,
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/guias/modificarGuia.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/guias/modificarNavBar.php`)
...
### `guias_navbar_translations_changelog`
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| idMasterNavBar | int | NO | MUL | NULL |  |
| field | varchar(256) | NO |  | NULL |  |
| old_value | text | YES |  | NULL |  |
| new_value | text | YES |  | NULL |  |
| created_at | timestamp | NO |  | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_guias_navbar_translations_changelog | BTREE | idMasterNavBar, created_at | No |
| idx_guias_navbar_translations_changelog_validated | BTREE | validated | No |

#### DDL

```sql
CREATE TABLE `guias_navbar_translations_changelog` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idMasterNavBar` int NOT NULL,
  `field` varchar(256) NOT NULL,
  `old_value` text,
  `new_value` text,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `validated` int DEFAULT '0' COMMENT '1 - Si 0 - No',
  PRIMARY KEY (`id`),
  KEY `idx_guias_navbar_translations_changelog` (`idMasterNavBar`,`created_at`),
  KEY `idx_guias_navbar_translations_changelog_validated` (`validated`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Track the changes made in the navbar'
```

### `guias_navbar_translations_changelog_validation`
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_guias_navbar_translations_changelog_validation | BTREE | idioma | No |

#### DDL

```sql
CREATE TABLE `guias_navbar_translations_changelog_validation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idCambio` int NOT NULL,
  `user` varchar(16) NOT NULL,
  `idioma` varchar(2) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_guias_navbar_translations_changelog_validation` (`idioma`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-ivan-enlaces.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/proveedores/modificarProveedor.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/hoteles/scripts/actualizarDistanciasCivitatis.php`)

#### Columnas

| Campo | Tipo | Null | Key | Default | Extra |
|-------|------|------|-----|---------|-------|
| id_pagina | int | NO | PRI | NULL |  |
| id_hotel | int | NO | PRI | NULL |  |
| nombre | varchar(128) | NO |  | NULL |  |
| url | varchar(128) | NO |  | NULL |  |
| ciudad | varchar(64) | NO |  | NULL |  |
...
| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | id_pagina, id_hotel | Sí |

#### DDL

```sql
CREATE TABLE `hoteles_cerca_de` (
  ...
  PRIMARY KEY (`id_pagina`,`id_hotel`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/tareas/imageExistsCache.php`)

#### Columnas

| Campo | Tipo | Null | Key | Default | Extra |
|-------|------|------|-----|---------|-------|
| idCiudad | int | NO | PRI | NULL |  |
| url | varchar(64) | NO | PRI | NULL |  |
| existe | tinyint | NO |  | NULL |  |

#### Índices

| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | idCiudad, url | Sí |
| idx_image_exists_cache_url | BTREE | url | No |

#### DDL

```sql
CREATE TABLE `image_exists_cache` (
  `idCiudad` int NOT NULL,
  `url` varchar(64) NOT NULL,
  `existe` tinyint NOT NULL,
  PRIMARY KEY (`idCiudad`,`url`),
  KEY `idx_image_exists_cache_url` (`url`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/web/empleo/index.php`)
...
CREATE TABLE `job_location` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1738 DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/modificarActividad.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/addGroupBookingCommissionToWallet.php`)
...
### `log_change_provider_tours`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/include/modificar_actividad_post.php`)
...
| old_value | int | YES |  | NULL |  |
| new_value | int | YES |  | NULL |  |
| created_at | timestamp | YES |  | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
...
```sql
CREATE TABLE `log_change_provider_tours` (
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/include/cambioEstadoActividad.php`)
...
### `log_provider_payments`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/include/actualizarImporteEbury.php`)
...
```sql
CREATE TABLE `log_provider_payments` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_user` int DEFAULT NULL,
  `text` text,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `provider_id` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb3 COMMENT='Log de pagos a proveedores'
```
...
| Campo | Tipo | Null | Key | Default | Extra |
|-------|------|------|-----|---------|-------|
| id_lugar | int | NO | PRI | NULL |  |
| id_lugar_cerca | int | NO | PRI | NULL |  |
| distancia | int | NO |  | NULL |  |
...
| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | id_lugar, id_lugar_cerca | Sí |

#### DDL

```sql
CREATE TABLE `lugares_cerca_de` (
  `id_lugar` int NOT NULL,
  `id_lugar_cerca` int NOT NULL,
  `distancia` int NOT NULL,
  PRIMARY KEY (`id_lugar`,`id_lugar_cerca`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
| fk_modality_label_translations | BTREE | label | No |
...
CREATE TABLE `modality` (
  ...
  `label` varchar(128) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `description` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`uuid`),
  KEY `fk_modality_label_translations` (`label`),
  CONSTRAINT `fk_modality_label_translations` FOREIGN KEY (`label`) REFERENCES `comun_variables_translations` (`label`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/fill_users_table.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/envioFacturasAVoxel.php`)
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| entity_type | int | NO | MUL | NULL |  |
| entity_id | varchar(256) | YES |  | NULL |  |
| json | mediumtext | YES |  | NULL |  |
| created_at | timestamp | NO |  | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_entity_type_entity_id | BTREE | entity_type, entity_id | No |

#### DDL

```sql
CREATE TABLE `navision_json` (
  `id` int NOT NULL AUTO_INCREMENT,
  `entity_type` int NOT NULL COMMENT '1. Actividades 2. Traslados 3. Rectif actividades 4. Rectif traslados 5. Tja regalo 6. Rectif tja regalo 7. Facturas proveedor 8. Facturas proveedor viejos 9. Facturas freetours 10. Autofactura afiliados',
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-reservas-carrito-nopagado.php`)
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_pages_translations_changelog_validated | BTREE | validated | No |
| idx_translations_changelog | BTREE | idMasterPage, created_at | No |

#### DDL

```sql
CREATE TABLE `pages_translations_changelog` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idMasterPage` int NOT NULL,
  `field` varchar(32) NOT NULL,
  `old_value` text,
  ...
  `validated` int DEFAULT '0' COMMENT '1 - Si 0 - No',
  PRIMARY KEY (`id`),
  KEY `idx_translations_changelog` (`idMasterPage`,`created_at`),
  KEY `idx_pages_translations_changelog_validated` (`validated`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Track the changes made in the pages'
```

### `pages_translations_changelog_validation`
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_translations_changelog_validation | BTREE | idioma | No |

#### DDL

```sql
CREATE TABLE `pages_translations_changelog_validation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idCambio` int NOT NULL,
  `user` varchar(16) NOT NULL,
  `idioma` varchar(2) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_translations_changelog_validation` (`idioma`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/include/menuGuideMaster.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/actividades/include/loadPassengerRequestInfo.php`)
...
### `pending_provider_invoices_freetour_bookings`
...
| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | booking_id | Sí |
| idx_ppifb_booking_id_provider_id | BTREE | booking_id, provider_id | No |
| idx_ppifb_provider_id_is_processed | BTREE | provider_id, is_processed | No |

#### DDL

```sql
CREATE TABLE `pending_provider_invoices_freetour_bookings` (
  `booking_id` int NOT NULL,
  `provider_id` int NOT NULL,
  ...
  KEY `idx_ppifb_booking_id_provider_id` (`booking_id`,`provider_id`),
  KEY `idx_ppifb_provider_id_is_processed` (`provider_id`,`is_processed`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Table for storing bookings that haven''t been invoiced yet, but their billing month has already been processed'
```

### `phpbb_users`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/tareas/usuarios/insertarUsuariosForo.php`)

#### Columnas

| Campo | Tipo | Null | Key | Default | Extra |
|-------|------|------|-----|---------|-------|
| user_id | mediumint | NO | PRI | NULL | auto_increment |
| user_type | tinyint | NO | MUL | 0 |  |
| group_id | mediumint | NO |  | 3 |  |
| user_permissions | mediumtext | NO |  | NULL |  |
| user_perm_from | mediumint | NO |  | 0 |  |
| user_ip | varchar(40) | NO |  |  |  |
| user_regdate | int | NO |  | 0 |  |
| username | varchar(255) | NO |  |  |  |
| username_clean | varchar(255) | NO | UNI |  |  |
| user_password | varchar(40) | NO |  |  |  |
| user_passchg | int | NO |  | 0 |  |
| user_pass_convert | tinyint | NO |  | 0 |  |
| user_email | varchar(100) | NO |  |  |  |
| user_email_hash | bigint | NO | MUL | 0 |  |
| user_birthday | varchar(10) | NO | MUL |  |  |
| user_lastvisit | int | NO |  | 0 |  |
| user_lastmark | int | NO |  | 0 |  |
| user_lastpost_time | int | NO |  | 0 |  |
| user_lastpage | varchar(200) | NO |  |  |  |
| user_last_confirm_key | varchar(10) | NO |  |  |  |
| user_last_search | int | NO |  | 0 |  |
| user_warnings | tinyint | NO |  | 0 |  |
| user_last_warning | int | NO |  | 0 |  |
| user_login_attempts | tinyint | NO |  | 0 |  |
| user_inactive_reason | tinyint | NO |  | 0 |  |
| user_inactive_time | int | NO |  | 0 |  |
| user_posts | mediumint | NO |  | 0 |  |
| user_lang | varchar(30) | NO |  |  |  |
| user_timezone | decimal(5,2) | NO |  | 0.00 |  |
| user_dst | tinyint | NO |  | 0 |  |
| user_dateformat | varchar(30) | NO |  | d M Y H:i |  |
| user_style | mediumint | NO |  | 0 |  |
| user_rank | mediumint | NO |  | 0 |  |
| user_colour | varchar(6) | NO |  |  |  |
| user_new_privmsg | int | NO |  | 0 |  |
| user_unread_privmsg | int | NO |  | 0 |  |
| user_last_privmsg | int | NO |  | 0 |  |
| user_message_rules | tinyint | NO |  | 0 |  |
| user_full_folder | int | NO |  | -3 |  |
| user_emailtime | int | NO |  | 0 |  |
| user_topic_show_days | smallint | NO |  | 0 |  |
| user_topic_sortby_type | varchar(1) | NO |  | t |  |
| user_topic_sortby_dir | varchar(1) | NO |  | d |  |
| user_post_show_days | smallint | NO |  | 0 |  |
| user_post_sortby_type | varchar(1) | NO |  | t |  |
| user_post_sortby_dir | varchar(1) | NO |  | a |  |
| user_notify | tinyint | NO |  | 0 |  |
| user_notify_pm | tinyint | NO |  | 1 |  |
| user_notify_type | tinyint | NO |  | 0 |  |
| user_allow_pm | tinyint | NO |  | 1 |  |
| user_allow_viewonline | tinyint | NO |  | 1 |  |
| user_allow_viewemail | tinyint | NO |  | 1 |  |
| user_allow_massemail | tinyint | NO |  | 1 |  |
| user_options | int | NO |  | 895 |  |
| user_avatar | varchar(255) | NO |  |  |  |
| user_avatar_type | tinyint | NO |  | 0 |  |
| user_avatar_width | smallint | NO |  | 0 |  |
| user_avatar_height | smallint | NO |  | 0 |  |
| user_sig | mediumtext | NO |  | NULL |  |
...
| user_occ | text | NO |  | NULL |  |
| user_interests | text | NO |  | NULL |  |
...
| Nombre | Tipo | Columnas | Único |
|--------|------|----------|-------|
| PRIMARY | BTREE | user_id | Sí |
| user_birthday | BTREE | user_birthday | No |
| user_email_hash | BTREE | user_email_hash | No |
| user_type | BTREE | user_type | No |
| username_clean | BTREE | username_clean | Sí |
...
CREATE TABLE `phpbb_users` (
  ...
  `group_id` mediumint NOT NULL DEFAULT '3',
  `user_permissions` mediumtext NOT NULL,
  `user_perm_from` mediumint NOT NULL DEFAULT '0',
  ...
  `user_pass_convert` tinyint NOT NULL DEFAULT '0',
  ...
  `user_dst` tinyint NOT NULL DEFAULT '0',
  `user_dateformat` varchar(30) NOT NULL DEFAULT 'd M Y H:i',
  `user_style` mediumint NOT NULL DEFAULT '0',
  `user_rank` mediumint NOT NULL DEFAULT '0',
  ...
  `user_message_rules` tinyint NOT NULL DEFAULT '0',
  ...
  `user_notify` tinyint NOT NULL DEFAULT '0',
  `user_notify_pm` tinyint NOT NULL DEFAULT '1',
  `user_notify_type` tinyint NOT NULL DEFAULT '0',
  `user_allow_pm` tinyint NOT NULL DEFAULT '1',
  `user_allow_viewonline` tinyint NOT NULL DEFAULT '1',
  `user_allow_viewemail` tinyint NOT NULL DEFAULT '1',
  `user_allow_massemail` tinyint NOT NULL DEFAULT '1',
  `user_options` int NOT NULL DEFAULT '895',
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/pois.php`)
...
| nombre | varchar(128) | NO |  | NULL |  |
| url_destino | varchar(128) | NO |  | NULL |  |
| latitud | double | NO |  | NULL |  |
| longitud | double | NO |  | NULL |  |
| categoria | tinyint | NO |  | NULL |  |
...
CREATE TABLE `pois` (
  ...
  `nombre` varchar(128) NOT NULL,
  `url_destino` varchar(128) NOT NULL,
  `latitud` double NOT NULL,
  `longitud` double NOT NULL,
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/guias/pois.php`)
...
```sql
CREATE TABLE `pois_translations` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_master_pois` int NOT NULL,
  `title` varchar(256) DEFAULT NULL,
  `lang` varchar(2) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_pois_translations_changelog | BTREE | idMasterPois, created_at | No |
| idx_pois_translations_changelog_validated | BTREE | validated | No |

#### DDL

```sql
CREATE TABLE `pois_translations_changelog` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idMasterPois` int NOT NULL,
  `field` varchar(256) NOT NULL,
  `old_value` text,
  `new_value` text,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `validated` int DEFAULT '0' COMMENT '1 - Si 0 - No',
  PRIMARY KEY (`id`),
  KEY `idx_pois_translations_changelog` (`idMasterPois`,`created_at`),
  KEY `idx_pois_translations_changelog_validated` (`validated`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='Track the changes made in pois'
```

### `pois_translations_changelog_validation`
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| idx_pois_translations_changelog_validation | BTREE | idioma | No |

#### DDL

```sql
CREATE TABLE `pois_translations_changelog_validation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idCambio` int NOT NULL,
  `user` varchar(16) NOT NULL,
  `idioma` varchar(2) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_pois_translations_changelog_validation` (`idioma`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/web/prensa/modificarNoticia.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/proveedores/index.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/proveedores/altaProveedor.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/proveedores/duplicarProveedor.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/proveedores/contratos.php`)
...
### `pt_refund_admin_params`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/script-refunds-adyen-ko-noMoneyNoPlay.php`)
...
```sql
CREATE TABLE `pt_refund_admin_params` (
  `id` int NOT NULL,
  `data` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/reintegros/eliminarReintegro.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/lib/Admin/RefundController.php`)
...
```sql
CREATE TABLE `reembolsos_totales` (
  `id` int NOT NULL AUTO_INCREMENT,
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/reintegros/index.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/web/rsc/index.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/web/rsc/archivos.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/web/rsc/modificarArchivo.php`)
...
CREATE TABLE `supplier` (
  ...
  `company` tinyint NOT NULL DEFAULT '1' COMMENT '1 Civitatis 2 Viajes con Encanto',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/suministradores/modificarSuministrador.php`)
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| fk_supplier_contact_detail_supplier_id | BTREE | supplier_id | No |

#### DDL

```sql
CREATE TABLE `supplier_contact_detail` (
  `id` int NOT NULL AUTO_INCREMENT,
  `supplier_id` int NOT NULL,
  `contact_name` varchar(50) NOT NULL,
  `email` varchar(128) NOT NULL,
  `email_copy` varchar(32) NOT NULL,
  `phone` varchar(32) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_supplier_contact_detail_supplier_id` (`supplier_id`),
  CONSTRAINT `fk_supplier_contact_detail_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```

### `supplier_contact_relation`
...
| id | int | NO | PRI | NULL | auto_increment |
| supplier_id | int | NO | MUL | NULL |  |
| supplier_contact_detail_id | int | NO | MUL | NULL |  |
| type | varchar(128) | NO |  | NULL |  |
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| fk_supplier_contact_relation_supplier_contact_detail_id | BTREE | supplier_contact_detail_id | No |
| fk_supplier_contact_relation_supplier_id | BTREE | supplier_id | No |

#### DDL

```sql
CREATE TABLE `supplier_contact_relation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `supplier_id` int NOT NULL,
  `supplier_contact_detail_id` int NOT NULL,
  `type` varchar(128) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_supplier_contact_relation_supplier_id` (`supplier_id`),
  KEY `fk_supplier_contact_relation_supplier_contact_detail_id` (`supplier_contact_detail_id`),
  CONSTRAINT `fk_supplier_contact_relation_supplier_contact_detail_id` FOREIGN KEY (`supplier_contact_detail_id`) REFERENCES `supplier_contact_detail` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_supplier_contact_relation_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```

### `supplier_fiscal_data`
...
| type_identification | varchar(2) | NO |  | NULL |  |
| identification | varchar(50) | NO |  | NULL |  |
| social_denomination | varchar(150) | NO |  | NULL |  |
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| fk_supplier_fiscal_data_country_id | BTREE | country_id | No |
| fk_supplier_fiscal_data_supplier_id | BTREE | supplier_id | No |

#### DDL

```sql
CREATE TABLE `supplier_fiscal_data` (
  `id` int NOT NULL AUTO_INCREMENT,
  `supplier_id` int NOT NULL,
  `country_id` int NOT NULL,
  `type_identification` varchar(2) NOT NULL,
  `identification` varchar(50) NOT NULL,
  `social_denomination` varchar(150) NOT NULL,
  `address` varchar(150) DEFAULT NULL,
  `cp` varchar(10) DEFAULT NULL,
  `city` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_supplier_fiscal_data_supplier_id` (`supplier_id`),
  KEY `fk_supplier_fiscal_data_country_id` (`country_id`),
  CONSTRAINT `fk_supplier_fiscal_data_country_id` FOREIGN KEY (`country_id`) REFERENCES `paises` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_supplier_fiscal_data_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```

### `supplier_method_of_payment`
...
| currency_id | int | YES | MUL | NULL |  |
| country_bank_id | int | YES | MUL | NULL |  |
| name_bank | varchar(50) | YES |  | NULL |  |
| name_account | varchar(150) | YES |  | NULL |  |
| iban | varchar(100) | YES |  | NULL |  |
| swift_bic | varchar(50) | YES |  | NULL |  |
| number_account | varchar(100) | YES |  | NULL |  |
| email | varchar(50) | YES |  | NULL |  |
| email_paypal | varchar(50) | YES |  | NULL |  |
...
|--------|------|----------|-------|
| PRIMARY | BTREE | id | Sí |
| fk_supplier_method_of_payment_method_of_payment_id | BTREE | method_of_payment_id | No |
| fk_supplier_method_of_payment_supplier_id | BTREE | supplier_id | No |
| idx_country_bank_id | BTREE | country_bank_id | No |
| idx_currency_id | BTREE | currency_id | No |
...
```sql
CREATE TABLE `supplier_method_of_payment` (
  `id` int NOT NULL AUTO_INCREMENT,
  `supplier_id` int NOT NULL,
  `method_of_payment_id` int NOT NULL,
  `currency_id` int DEFAULT NULL,
  ...
  `email_paypal` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_supplier_method_of_payment_supplier_id` (`supplier_id`),
  KEY `fk_supplier_method_of_payment_method_of_payment_id` (`method_of_payment_id`),
  KEY `idx_currency_id` (`currency_id`),
  KEY `idx_country_bank_id` (`country_bank_id`),
  CONSTRAINT `fk_supplier_method_of_payment_method_of_payment_id` FOREIGN KEY (`method_of_payment_id`) REFERENCES `method_of_payment` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_supplier_method_of_payment_supplier_id` FOREIGN KEY (`supplier_id`) REFERENCES `supplier` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/guias/modificarTag.php`)
...
CREATE TABLE `top_pages` (
  `id` int NOT NULL AUTO_INCREMENT,
  `master_page_id` int DEFAULT NULL,
  `picture` varchar(256) DEFAULT NULL,
  `priority` int DEFAULT NULL COMMENT 'Higher means more important',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
CREATE TABLE `transfer_faq` (
  ...
  `active` tinyint DEFAULT '1' COMMENT '0.Desactivada 1.Activa',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='faqs de traslados'
```

### `transfer_faq_changelog`
...
```sql
CREATE TABLE `transfer_faq_changelog` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idFaq` int DEFAULT NULL,
  `user` varchar(16) DEFAULT NULL,
  `old_value` text,
...
### `transfer_faq_changelog_validation`
...
```sql
CREATE TABLE `transfer_faq_changelog_validation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idChange` int DEFAULT NULL,
  `user` varchar(16) DEFAULT NULL,
  `lang` varchar(2) DEFAULT NULL,
...
### `traslados_cancelaciones`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/traslados/verReserva.php`)
...
```sql
CREATE TABLE `traslados_cancelaciones` (
  `id` int NOT NULL,
  `num_devolucion` int NOT NULL,
  `fecha` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/proveedores/addSillasBebe.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/facturacion/excelVentas.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/traslados/fechasOcupadas.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/traslados/ciudades.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/proveedores/loadTransfersProvider.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/traslados/vehiculos.php`)
...
```sql
CREATE TABLE `type_bank_identification` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(128) DEFAULT NULL,
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/buscar_ajax.php`)
...
### `user_legal_communications`

**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/it/bajaEmailUsuario.php`)
...
| terms_accepted | tinyint | NO |  | NULL |  |
| terms_accepted_timestamp | timestamp | YES |  | NULL |  |
| allow_comms | tinyint | YES |  | NULL |  |
| allow_comms_timestamp | timestamp | YES |  | NULL |  |
| allow_sharing_opinions | tinyint(1) | YES |  | NULL |  |
...
```sql
CREATE TABLE `user_legal_communications` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `email` varchar(150) NOT NULL,
  `terms_accepted` tinyint NOT NULL,
  `terms_accepted_timestamp` timestamp NULL DEFAULT NULL,
  `allow_comms` tinyint DEFAULT NULL COMMENT '0 - Subscribed = Nunca me he suscrito; 1 - opt-in = Estoy suscrito; 2 - Unsubscribed = Me he dado de baja desde mail o desde panel cliente',
  `allow_comms_timestamp` timestamp NULL DEFAULT NULL,
  `allow_sharing_opinions` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/web/concursos/estadisticasConcurso.php`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/tareas/correo/eliminarCorreos.php`)
...
| pais | char(3) | NO |  | NULL |  |
| ciudad | varchar(64) | NO |  | NULL |  |
| codigo_postal | varchar(15) | NO |  | NULL |  |
| fecha_nacimiento | date | NO |  | NULL |  |
| telefono | varchar(24) | NO |  | NULL |  |
| sexo | char(1) | YES |  | NULL |  |
| ip | varchar(32) | NO |  | NULL |  |
| fecha_agregado | timestamp | NO |  | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
| origen | tinyint | NO |  | NULL |  |
...
CREATE TABLE `usuarios` (
  ...
  `origen` tinyint NOT NULL COMMENT '1 Reservas 2 Contacto 3 Foro 4 Coches',
  PRIMARY KEY (`id`),
  UNIQUE KEY `email` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=22638 DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/viajes/viajes.php`)
...
|-------|------|------|-----|---------|-------|
| id | smallint | NO | PRI | NULL | auto_increment |
| id_pais | smallint | NO |  | NULL |  |
| id_ciudad | smallint | NO |  | NULL |  |
| id_proveedor | smallint | NO |  | NULL |  |
| url | varchar(64) | NO |  | NULL |  |
| titulo | varchar(64) | NO |  | NULL |  |
| titulo_proveedor | varchar(64) | NO |  | NULL |  |
| destinos | varchar(128) | NO |  | NULL |  |
| resumen | varchar(256) | NO |  | NULL |  |
| descripcion | text | NO |  | NULL |  |
| imagen | varchar(128) | NO |  | NULL |  |
| keywords | varchar(256) | NO |  | NULL |  |
| origenes | varchar(128) | NO |  | NULL |  |
| fechas | varchar(128) | NO |  | NULL |  |
| alojamiento | text | NO |  | NULL |  |
| precio_desde | double | NO |  | NULL |  |
| divisa | varchar(3) | NO |  | NULL |  |
| precios_categorias | varchar(256) | YES |  | NULL |  |
| precios_edades | varchar(128) | NO |  | NULL |  |
| precios_notas | varchar(256) | NO |  | NULL |  |
| incluido | text | NO |  | NULL |  |
| no_incluido | text | NO |  | NULL |  |
| cancelaciones | text | NO |  | NULL |  |
| duracion | varchar(64) | NO |  | NULL |  |
| idioma | smallint | NO |  | NULL |  |
| notas_importantes | text | NO |  | NULL |  |
| activo | tinyint | NO |  | 0 |  |
| personas | int | NO |  | NULL |  |
| opiniones | int | NO |  | NULL |  |
| valoracion | double | NO |  | NULL |  |
| popularidad | int | NO |  | NULL |  |
| freesale | varchar(2) | YES |  | no |  |
| beneficio | int | YES |  | 0 |  |
| antelacion | int | YES |  | 0 |  |
...
CREATE TABLE `viajes` (
  ...
  `url` varchar(64) NOT NULL,
  `titulo` varchar(64) NOT NULL,
  `titulo_proveedor` varchar(64) NOT NULL,
  `destinos` varchar(128) NOT NULL,
  `resumen` varchar(256) NOT NULL,
  `descripcion` text NOT NULL,
  `imagen` varchar(128) NOT NULL,
  `keywords` varchar(256) NOT NULL,
  `origenes` varchar(128) NOT NULL,
  `fechas` varchar(128) NOT NULL,
  `alojamiento` text NOT NULL,
  `precio_desde` double NOT NULL,
  `divisa` varchar(3) NOT NULL,
  `precios_categorias` varchar(256) DEFAULT NULL,
  `precios_edades` varchar(128) NOT NULL,
  `precios_notas` varchar(256) NOT NULL,
  `incluido` text NOT NULL,
  `no_incluido` text NOT NULL,
  `cancelaciones` text NOT NULL,
  `duracion` varchar(64) NOT NULL,
  `idioma` smallint NOT NULL,
  `notas_importantes` text NOT NULL,
  `activo` tinyint NOT NULL DEFAULT '0',
  `personas` int NOT NULL,
  `opiniones` int NOT NULL,
  `valoracion` double NOT NULL,
  `popularidad` int NOT NULL,
  `freesale` varchar(2) DEFAULT 'no',
  `beneficio` int DEFAULT '0',
  `antelacion` int DEFAULT '0',
  PRIMARY KEY (`id`)
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/viajes/modificarViaje.php`)
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| id_viaje | smallint | NO |  | NULL |  |
| fecha_inicio | date | NO |  | 2014-09-01 |  |
| fecha_fin | date | NO |  | 2019-01-01 |  |
| dias | varchar(16) | NO |  | NULL |  |
| precios | varchar(128) | NO |  | NULL |  |
...
```sql
CREATE TABLE `viajes_fechas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_viaje` smallint NOT NULL,
  `fecha_inicio` date NOT NULL DEFAULT '2014-09-01',
  `fecha_fin` date NOT NULL DEFAULT '2019-01-01',
  `dias` varchar(16) NOT NULL,
  `precios` varchar(128) NOT NULL,
  PRIMARY KEY (`id`)
...
|-------|------|------|-----|---------|-------|
| id | int | NO | PRI | NULL | auto_increment |
| id_viaje | int | NO |  | NULL |  |
| titulo | varchar(64) | NO |  | NULL |  |
| carpeta | varchar(84) | NO |  | NULL |  |
| archivo | varchar(64) | NO |  | NULL |  |
| ancho_thumb | int | NO |  | NULL |  |
| alto_thumb | int | NO |  | NULL |  |
...
```sql
CREATE TABLE `viajes_imagenes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_viaje` int NOT NULL,
  `titulo` varchar(64) NOT NULL,
  `carpeta` varchar(84) NOT NULL,
  `archivo` varchar(64) NOT NULL,
  `ancho_thumb` int NOT NULL,
  `alto_thumb` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=913 DEFAULT CHARSET=utf8mb3
```
...
| id_ciudad | int | NO |  | NULL |  |
| titulo | varchar(64) | NO |  | NULL |  |
| categoria | varchar(32) | NO |  | NULL |  |
| fecha | date | YES |  | NULL |  |
| numero_personas | tinyint | YES |  | NULL |  |
| texto_personas | varchar(128) | NO |  | NULL |  |
| numero_habitaciones | tinyint | NO |  | NULL |  |
| precio | float | NO |  | 0 |  |
| cobrado | float | NO |  | 0 |  |
| pagado | float | NO |  | NULL |  |
| beneficio | float | NO |  | NULL |  |
| comision | float | NO |  | NULL |  |
| divisa | varchar(3) | NO |  | NULL |  |
| tipo_cambio | float | NO |  | 1 |  |
| divisa_pago | varchar(3) | NO |  | NULL |  |
| nombre | varchar(64) | NO |  | NULL |  |
| apellidos | varchar(64) | NO |  | NULL |  |
| email | varchar(256) | NO |  | NULL |  |
| ciudad_salida | varchar(64) | NO |  | NULL |  |
| pais | char(4) | NO |  | NULL |  |
| telefono | varchar(32) | YES |  | NULL |  |
| comentarios | text | YES |  | NULL |  |
| contacto | tinyint | NO |  | NULL |  |
| notas_internas | text | NO |  | NULL |  |
| estado | tinyint | NO |  | 0 |  |
| fecha_reserva | timestamp | NO |  | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
| fecha_cobro | timestamp | YES |  | NULL |  |
| pin | int | NO |  | NULL |  |
| ip | varchar(32) | NO |  | NULL |  |
| id_recibo | varchar(32) | NO |  | NULL |  |
| num_transaccion | varchar(20) | NO |  | NULL |  |
| num_factura | int | NO |  | NULL |  |
| localizador | varchar(32) | NO |  | NULL |  |
| fecha_pago | date | YES |  | NULL |  |
| booking_attempts | tinyint | YES |  | 0 |  |
| fp | varchar(16) | YES |  | NULL |  |
| importePago | float | YES |  | NULL |  |
| userAgent | text | YES |  | NULL |  |
| precioEuros | float | YES |  | NULL |  |
| cobradoEuros | float | YES |  | NULL |  |
| pagadoEuros | float | YES |  | NULL |  |
| beneficioEuros | float | YES |  | NULL |  |
| xrt_payment_currency | float | YES |  | NULL |  |
| xrt_eur | float | YES |  | NULL |  |
...
CREATE TABLE `viajes_reservas` (
  ...
  `fecha` date DEFAULT NULL,
  `numero_personas` tinyint DEFAULT NULL,
  `texto_personas` varchar(128) NOT NULL,
  `numero_habitaciones` tinyint NOT NULL,
  ...
  `comision` float NOT NULL,
  `divisa` varchar(3) NOT NULL,
  `tipo_cambio` float NOT NULL DEFAULT '1',
  `divisa_pago` varchar(3) NOT NULL,
  `nombre` varchar(64) NOT NULL,
  `apellidos` varchar(64) NOT NULL,
  `email` varchar(256) NOT NULL,
  `ciudad_salida` varchar(64) NOT NULL,
  `pais` char(4) NOT NULL,
  `telefono` varchar(32) DEFAULT NULL,
  `comentarios` text,
  `contacto` tinyint NOT NULL COMMENT '0 No llamar 1 Todo el día 2 Mañanas 3 Tardes',
  `notas_internas` text NOT NULL,
  `estado` tinyint NOT NULL DEFAULT '0' COMMENT '0 Recibido 1 Con Plazas 2 Sin plazas 3 Plazas pedidas 4 Plazas bloqueadas 5 Pagado parcialmente 6 Pagado totalmente 7 Vendido 8 Cancelado',
  `fecha_reserva` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `fecha_pago` date DEFAULT NULL COMMENT 'Fecha de pago al proveedor',
  `booking_attempts` tinyint DEFAULT '0',
  `fp` varchar(16) DEFAULT NULL,
  `importePago` float DEFAULT NULL,
  `userAgent` text,
  `precioEuros` float DEFAULT NULL,
  `cobradoEuros` float DEFAULT NULL,
  `pagadoEuros` float DEFAULT NULL,
  `beneficioEuros` float DEFAULT NULL,
  `xrt_payment_currency` float DEFAULT NULL COMMENT 'Stores the effective exchange rate from contract currency to selected payment currency',
  `xrt_eur` float DEFAULT NULL COMMENT 'Stores the effective exchange rate from contract currency to euro',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2358 DEFAULT CHARSET=utf8mb3
```
...
CREATE TABLE `voxel_data` (
  ...
  `entity_id` varchar(256) DEFAULT NULL,
  `data` blob,
  `data_type` int NOT NULL COMMENT '1. XML 2. JSON',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3
```
...
**Usado por:**
- `old-admin` (scope /admin): p.ej. (`application/admin/destinos/modificarZona.php`)
