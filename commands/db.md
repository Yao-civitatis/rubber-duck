...
duck-db "redacta la query para marcar como cancelados los bookings del proveedor X"
duck-db PANA-789                    # analiza qué queries necesita el ticket
```
