...
| `2026-05-28_plan_analyze_hidden_markers_and_plan_file_input_v1.md` | (abierto) | Plan de 2 features: (A) ocultar marcadores `<!-- rubber-duck:* -->` y "Generado por" en la descripción de Jira; (B) `duck-plan <archivo.md>` como input alternativo a la JIRA-KEY. S1 activo; S2 pending planning. Incluye Closure Protocol. |
